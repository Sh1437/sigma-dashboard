        ...
        <div class="mx-auto max-w-[920px]">
          ...
          <div class="role-access-card rounded-[14px] border border-[#dce5f0] bg-white p-6 shadow-sm">
            <div class="border-b border-[#e6ecf4] pb-5">
              <h1 class="role-page-title text-[22px] font-extrabold text-[#071d43]">Ubah Data Blacklist Driver</h1>
            ...
            @endif
            <form method="POST" action="{{ route('blacklist-driver.update', $user['identity']) }}" class="mt-6 grid grid-cols-1 gap-5 md:grid-cols-2">
              @csrf
              @method('PUT')
